...
def TrackCompFunc(y, r, e, d1, d2, t1, t2):
    ...
    driver1_color = ff1.plotting.team_color('RBR')
    driver2_color = ff1.plotting.team_color('MCL')
    ...
    # nu vreau cbar = plt.colorbar(mappable=lc_comp, boundaries=np.arange(1,4))
    ...
    plt.savefig("Driver comparison track")
